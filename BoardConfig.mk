...
# Defina SELinux para permissivo
BOARD_SEPOLICY_DIRS += system/sepolicy
BOARD_SEPOLICY_UNION := true
BOARD_SEPOLICY_LOAD := true
BOARD_SEPOLICY_DEFAULT_ENFORCE := false
